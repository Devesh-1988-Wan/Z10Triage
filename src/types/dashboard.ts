...
export interface WidgetConfig {
  ...
  component: 'MetricCard' | 'BugChart' | 'CustomerSupportTable' | 'DevelopmentPipeline' | 'DataManagement' | 'SecurityInfrastructureUpdates' | 'HeaderWidget' | 'InfoCardWidget'; // The React component name
