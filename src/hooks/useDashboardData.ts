...
export const DEFAULT_DASHBOARD_LAYOUT: DashboardLayout = {
  widgets: [
    ...
    },
    {
      ...
      description: 'Webstore, DAM, Tenant issues - 91%',
      props: {
        icon: 'Zap',
        change: { value: '+2%', trend: 'up' },
        valueKey: 'functionalStability',
      },
    ...
    },
    {
      ...
      component: 'MetricCard',
      title: 'Performance',
      description: 'Cart checkout slowness - 4%',
      props: {
        icon: 'TrendingUp',
        priority: 'critical',
    ...
    },
    {
      ...
      component: 'MetricCard',
      title: 'Queries',
      description: 'Checkout & font issues - 3%',
      props: {
        icon: 'Bug',
        priority: 'medium',
        valueKey: 'queries',
    ...
    },
    {
      ...
      component: 'MetricCard',
      title: 'Look & Feel',
      description: 'UI & display issues - 2%',
      props: {
        icon: 'Shield',
        priority: 'low',
        valueKey: 'lookFeel',
